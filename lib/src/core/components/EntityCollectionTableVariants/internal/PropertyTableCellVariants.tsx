...
import { TableReferenceField } from "../../EntityCollectionTable/fields/TableReferenceField";

import { getPreviewSizeFrom } from "../../../../preview/util";
import { isReadOnly } from "../../../util";
import { TableStorageUpload } from "../../EntityCollectionTable/fields/TableStorageUpload";
import {
    CustomFieldValidator,
    mapPropertyToYup
} from "../../../../form/validation";
import { useEntityCollectionTableVariantsController } from "../EntityCollectionTableVariants";
import {
...
export const PropertyTableCellParents = React.memo<PropertyTableCellProps<any, any>>(
    function PropertyTableCellParents<T extends CMSType, M extends Record<string, any>>({
                                                                                     propertyKey,
                                                                                     columnIndex,
                                                                                     customFieldValidator,
                                                                                     value,
        ...
        const {
            ...
            setPopupCell,
            selectedEntityIds
        } = useEntityCollectionTableVariantsController();

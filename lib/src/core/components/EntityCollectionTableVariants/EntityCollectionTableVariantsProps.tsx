 ...
 */
export type EntityCollectionTableVariantsProps<M extends Record<string, any>> =
    EntityCollection<M>
    & {
    ...
    /**
     * Handler for row height expansion
     * @param index the index of the row where the table is displayed
     */
    onRowExpand?(): void;

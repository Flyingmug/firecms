...
import { PropertyTableCellParents } from "./internal/PropertyTableCellVariants";
...
import { EntityCollectionTableVariantsProps } from "./EntityCollectionTableVariantsProps";
...
import { CollectionTableToolbarVariants } from "./internal/CollectionTableToolbarVariants";

const DEFAULT_STATE = {} as any;

export const EntityCollectionTableVariantsContext = React.createContext<EntityCollectionTableController<any>>(DEFAULT_STATE);

export const useEntityCollectionTableVariantsController = () => useContext<EntityCollectionTableController<any>>(EntityCollectionTableVariantsContext);
 ...
 *
 * @see EntityCollectionTableParentsProps
 * @see EntityCollectionView
 * @see VirtualTable
 * @category Components
 */
export const EntityCollectionTableVariants = React.memo<EntityCollectionTableVariantsProps<any>>(
    function EntityCollectionTableVariants<M extends Record<string, any>, AdditionalKey extends string, UserType extends User>
    ({
         fullPath,
         initialFilter,
         initialSort,
         ...
         ...collection
     }: EntityCollectionTableVariantsProps<M>) {
        ...
        return (
            ...
            <EntityCollectionTableVariantsContext.Provider
                value={{
                    setPopupCell,
                    select,
                    onValueChange,
            ...
            >
                ...
                <Box sx={(theme) => ({
                    ...
                    <Box sx={{
                        flexGrow: 1,
                        display: 'flex',
                        maxHeight: isOpen ? '300px' : '0px',  // Adjust max height as needed
                        opacity: isOpen ? 1 : 0,
                        visibility: isOpen ? 'visible' : 'hidden',
                        transition: 'max-height .35s, opacity .35s ease, visibility .35s ease'
                    }}>
                        <VirtualTable
                            data={data}
                            columns={columns}

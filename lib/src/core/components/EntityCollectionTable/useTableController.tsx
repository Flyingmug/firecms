...
export type ParentsTableControllerProps<M extends Record<string, any> = any, S extends Record<string, any> = any> = {
    fullPath: string;
    collection: EntityCollection<M>;
    parentsCollection: EntityCollection<S>;
    /**
     * List of entities that will be displayed on top, no matter the ordering.
     * This is used for reference fields selection
     */
...
// test
export function useCustomTableController<M extends Record<string, any> = any, S extends Record<string, any> = any, UserType extends User = User>(
    {
        fullPath,
        collection,
        parentsCollection,
        ...
        lastDeleteTimestamp,
        forceFilter: forceFilterFromProps
    }: ParentsTableControllerProps<M, S>)
    : TableController<M> {
    ...
    // trying to fetch the second collection
    const {
        data: parentsData,
        dataLoading: parentsDataLoading,
        noMoreToLoad: parentsNoMoreToLoad,
        dataLoadingError: parentsDataLoadingError
    } = useCollectionFetch<S, UserType>({
        path: fullPath,
    ...
    // fusing the two collections together

 ...
 * @category Components
 */
export const EntityCollectionTableParents = React.memo<EntityCollectionTableParentsProps<any>>(
    function EntityCollectionTableParents<M extends Record<string, any>, AdditionalKey extends string, UserType extends User>
    ({
         deepCollection,
         fullPath,
         initialFilter,
         ...
         ...collection
     }: EntityCollectionTableParentsProps<M>) {

 ...
 * @category Components
 */
export interface ProductEntityFormPageProps<M extends Record<string, any>> {
 ...
 * @category Components
 */
export const ProductEntityFormPage = React.memo<ProductEntityFormPageProps<any>>(EntityFormInternal,
